...
export function MagicCard(props: MagicCardProps) {
  ...
  const glowFrom = isOrbMode(props) ? (props.glowFrom ?? "#818cf8") : "#818cf8"
  const glowTo = isOrbMode(props) ? (props.glowTo ?? "#6366f1") : "#6366f1"
  ...
  return (
    ...
    >
      <div className="bg-[#09090b] absolute inset-px z-20 rounded-[inherit]" />
